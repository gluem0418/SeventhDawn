<template>
  ...
  <div v-if="battleProcess !== 'encount' && battleProcess !== 'result'" class=BattleUI>
    ...
    <div class=monsterGrid>
      <div v-for="(cell, index) in monsterGrid" :key="index" class="monsterCell" :class="{
        ...
        <div v-if="cell" @click="clickTarget(index, cell)" @mouseover="overTarget(index, cell)"
          ...
          <img :src="cell.GraphicUrl" class="monsterImage" :id="'monsterImage' + index" alt="monsterImage"
            :class="{ normalMonster: cell.mon_type == 1 }">
        </div>
    ...
    <CurrentUI class="CurrentUI" :currentCharacter="currentCharacter" :targetCharacter="targetCharacter"
      ...
      :toCharacterEffectType="toCharacterEffectType" :selectionMode="selectionMode" @selectCharacter='selectCharacter'
      @skillAnimeFinish='skillAnimeFinish' @effectFinish='effectFinish' />

    <ActionLog ref="actionLog" class="actionLog" />

    <!-- icon  -->
    <div v-if="battleProcess == 'characterTurn' || battleProcess == 'selectTarget'">
      <IconAttack id="IconAttack" class="IconAttack" @click="clickIcon(bConfig.actionAttack)"
        :style="styles.AttackBtn" />
      <IconSkill id="IconAttack" class="IconSkill" @click="clickIcon(bConfig.actionSkill)"
        :characterType="characterType" :style="styles.SkillBtn" />
